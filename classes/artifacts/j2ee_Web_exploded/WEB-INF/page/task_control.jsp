...
<body>
 <div style="text-align:center; height:100px;width:500px">
...
<div style="text-align:center; height:100px;width:500px">
<select id="task_select" style="width:150px;height:30px"/>
<option></option>
<option>移动</option>
<option>取货</option>
<option>放货</option>
</select>
<input type="button" class="btn btn-primary" id="task" value="发布任务" onclick="showAtRight('task')" />
