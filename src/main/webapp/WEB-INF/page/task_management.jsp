...
<div style =margin-left:10%;>
   任务名称<input id="task_name">
    任务起点<input  id="task_start">
    任务终点<input  id="task_end">
    任务动作<input  id="task_movement">
...
             <th width="4%"><font size="2">任务名称</font></th>
             <th width="4%"><font size="2">任务起点</font></th>
			<th width="4%"><font size="2">任务终点</font></th>
			<th width="4%"><font size="2">任务动作</font></th>
